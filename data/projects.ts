...
export const projects: Project[] = [
  {
    ...
    github: 'https://github.com/georgenageh2004/AXIS',
    live: 'https://axis-d1d75.web.app',
    image: '/Axis.png',
    featured: true,
    color: 'blue',
  },
  {
    ...
    github: 'https://github.com/georgenageh2004/George_ecommerce',
    live: 'https://georgenageh2004.github.io/George_ecommerce/',
    image: '/ecommerce.png',
    featured: true,
    color: 'green',
  },
  {
    ...
    live: 'https://neuronote.runasp.net',
    image: '/NeuroNote.png',
    featured: false,
    color: 'orange',
  },
